...
const PORT = 8080;
export const URL_BASE_PATH = `http://localhost:${PORT}`;
...
server.listen(8080, function () {
	...
	console.log('');
	console.log(
		'You are using a fake rest server that provides features like filtering, pagination and full-text search. Checkout https://www.npmjs.com/package/json-server'
	);
	console.log('');
